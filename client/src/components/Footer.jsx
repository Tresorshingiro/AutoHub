        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-primary-foreground/80 mb-6 max-w-md">
              The complete garage management solution trusted by professionals worldwide. 
              ...
              <ul className="space-y-2">
                {links.map((link) => (
                  <li key={link.name}>
                    <a 
                      href={link.href} 
                      className="text-primary-foreground/70 hover:text-garage-green transition-colors duration-300 text-sm"
                    >
                      {link.name}
                    </a>
                  </li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-primary-foreground/70 hover:text-garage-green transition-colors duration-300">
